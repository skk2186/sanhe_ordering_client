    ...
    <div v-if="item" class="menu-item-detail">
      ...
      <div class="image-carousel">
        ...
        <div class="item-badges">
          <span v-if="item.isNew" class="badge new-badge">新品</span>
      ...
      <div class="item-content">
        <div class="item-header">
          ...
          <div class="item-rating" v-if="item.rating">
            ...
            />
            <span class="rating-count">({{ item.reviewCount }}评价)</span>
          </div>
        </div>
        ...
        <div class="customization-section" v-if="item.customizations?.length">
          ...
          >
            <div class="group-header">
              ...
              <span v-if="customization.required" class="required-tag">必选</span>
            </div>
        ...
        <div class="special-requests">
          ...
          <el-input
            ...
            type="textarea"
            :rows="3"
            placeholder="请输入特殊要求（如：少盐、不要芥末等）"
            maxlength="100"
            show-word-limit
          />
        </div>
