    ...
    <div class="gacha-machine">
            ...
            <div class="display-screen">
              <div class="screen-content">
                <div v-if="!isPlaying && !reward" class="welcome-text">
                  <h3>{{ $t('gacha.chance') }}</h3>
                  <p>{{ $t('gacha.startHint') }}</p>
                </div>
          ...
          <div class="machine-bottom">
            <div class="control-panel">
              ...
              >
                ...
                {{ isPlaying ? $t('gacha.playing') : $t('gacha.start') }}
              </el-button>
            </div>
      ...
      <div v-if="reward" class="reward-details">
          ...
          <div class="reward-item">
            ...
            <div class="reward-text">
              ...
              <div class="reward-value" v-if="reward.value">
                {{ reward.type === 'points' ? $t('gacha.pointsValue', { value: reward.value }) : reward.value }}
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="action-buttons">
          <el-button @click="closeDialog">{{ $t('gacha.useLater') }}</el-button>
...
const rewardPool = computed(() => [
  {
    id: 1,
    name: t('gacha.pointsReward'),
    description: t('gacha.pointsDescription'),
    type: 'points',
    value: 50,
    probability: 0.4,
    color: '#FFD700',
  ...
  {
    id: 2,
    name: t('gacha.couponReward'),
    description: t('gacha.couponDescription'),
    type: 'coupon',
    value: '满100减20',
    probability: 0.3,
    color: '#FF6B6B',
  ...
  {
    id: 3,
    name: t('gacha.sushiReward'),
    description: t('gacha.sushiDescription'),
    type: 'item',
    value: '三文鱼寿司',
    probability: 0.2,
    color: '#4ECDC4',
  ...
  {
    id: 4,
    name: t('gacha.grandReward'),
    description: t('gacha.grandDescription'),
    type: 'special',
    value: '会员升级券',
    probability: 0.1,
    color: '#9B59B6',
...
const startGacha = async () => {
  ...
  setTimeout(() => {
    ...
    for (const rewardItem of rewardPool.value) {
...
const useReward = () => {
  ElMessage.success(t('gacha.used', { name: reward.value.name }))
  closeDialog()
}
