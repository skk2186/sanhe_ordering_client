        ...
        >
          ...
          <div class="item-info">
            ...
            <div v-if="item.specialRequest" class="special-request">
              <span class="request-label">{{ $t('menu.specialRequest') }}:</span>
      ...
      <div class="cart-footer">
        ...
        <div class="coupon-section">
          ...
          >
            ...
            <span v-if="selectedCoupon">{{ $t('cart.selectedCoupon') }}</span>
            <span v-else>{{ $t('cart.selectCoupon') }}</span>
          </el-button>
        </div>
        ...
        >
          {{ $t('cart.checkout') }} ({{ $t('cart.itemCount', { count: totalItems }) }})
        </el-button>
      </div>
    </template>
...
const removeItem = async (itemId) => {
  try {
    await ElMessageBox.confirm(t('cart.removeConfirm'), t('common.prompt'), {
...
const selectCoupon = (coupon) => {
  ...
  ElMessage.success(t('cart.couponApplied', { name: coupon.name }))
}
