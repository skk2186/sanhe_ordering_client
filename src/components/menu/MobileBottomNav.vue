  ...
  <div class="mobile-bottom-nav">
    <div class="nav-container">
      ...
      <div class="nav-item" @click="$emit('show-categories')">
        ...
        <span class="nav-label">{{ $t('menu.category') }}</span>
      </div>
      ...
      <div class="nav-item" @click="showSearchDialog">
        ...
        <span class="nav-label">{{ $t('common.search') }}</span>
      </div>
      ...
      <div class="nav-item" :class="{ 'active': isHomePage }" @click="goToHome">
        ...
        <span class="nav-label">{{ $t('common.home') }}</span>
      </div>
      ...
      <div class="nav-item cart-item" @click="$emit('show-cart')">
        ...
        <span class="nav-label">{{ $t('cart.title') }}</span>
      ...
      <div class="nav-item" @click="showUserMenu">
        ...
        <span class="nav-label">{{ $t('common.mine') }}</span>
      </div>
    </div>
    ...
    >
      <div class="search-content">
        ...
        <div v-if="!searchKeyword && searchHistory.length > 0" class="search-history">
          <div class="history-header">
            <span>{{ $t('menu.searchHistory') }}</span>
        ...
        <div v-if="searchResults.length > 0" class="search-results">
          <div class="results-header">
            <span>{{ $t('menu.searchResults', { count: searchResults.length }) }}</span>
          </div>
      ...
      <template #footer>
        <el-button @click="searchDialogVisible = false">{{ $t('common.cancel') }}</el-button>
      ...
      <div class="user-content">
        ...
        <div class="user-info">
          ...
          <div class="user-details">
            <h3>{{ authStore.user?.username || $t('common.user') }}</h3>
            <p v-if="authStore.isCustomer">{{ $t('cart.table') }}: {{ authStore.user?.tableNumber }}</p>
        ...
        <div class="menu-options">
          ...
          <div class="menu-item" @click="toggleTheme">
            ...
            <span>{{ globalStore.isDark ? $t('common.lightMode') : $t('common.darkMode') }}</span>
            <el-icon><ArrowRight /></el-icon>
          </div>
...
const hotSearches = computed(() => ['sushi', 'sashimi', 'tempura', 'ramen', 'grilledFish'].map(key => t(`menu.hot.${key}`)))
...
const selectSearchResult = (item) => {
  ...
  ElMessage.success(t('menu.selectedItem', { name: item.name }))
}
...
const clearSearchHistory = () => {
  ...
  searchHistory.value = []
  ElMessage.success(t('menu.historyCleared'))
}
