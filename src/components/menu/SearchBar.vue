  ...
  <div class="search-bar">
    <div class="search-input-section">
      ...
      <div class="main-search">
        <el-input
          ...
          :placeholder="$t('menu.searchDishDetail')"
          size="large"
          clearable
      ...
      >
        ...
        {{ showAdvanced ? $t('menu.collapse') : $t('menu.advancedSearch') }}
      </el-button>
    </div>
      ...
      <div v-show="showAdvanced" class="advanced-search">
        <div class="search-filters">
          ...
          <div class="filter-group">
            <label class="filter-label">{{ $t('menu.priceRange') }}</label>
          ...
          <!-- 分类筛选 -->
          <div class="filter-group">
            <label class="filter-label">{{ $t('menu.category') }}</label>
            <el-select
        ...
        <div class="search-actions">
          ...
          <el-button type="primary" @click="handleSearch">{{ $t('menu.applyFilter') }}</el-button>
        </div>
      </div>
    </div>
    </el-collapse-transition>
    ...
    <div v-if="showSuggestions && searchSuggestions.length > 0" class="search-suggestions">
      <div class="suggestions-header">
        <span>{{ $t('menu.searchSuggestions') }}</span>
      ...
      <div class="history-list">
        ...
        >
          <div class="history-content">
            ...
            <span class="history-count">{{ $t('menu.searchTimes', { count: item.count }) }}</span>
          </div>
          <el-button
            type="text"
            size="small"
