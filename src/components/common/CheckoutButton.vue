  ...
  <div class="checkout-button-container">
    ...
    >
      ...
      <template v-if="loading">
        ...
        <span class="checkout-text">{{ t('common.processing') }}</span>
      </template>
      ...
      <template v-else-if="isEmpty">
        ...
        <span class="checkout-text">{{ t('cart.empty') }}</span>
      </template>
      ...
      <template v-else>
        ...
        <div class="checkout-content">
          <span class="checkout-text">{{ t('cart.checkout') }}</span>
          <div class="checkout-details">
            <span class="item-count">{{ t('cart.itemCount', { count: itemCount }) }}</span>
    ...
    <div v-if="discount > 0 && !isEmpty" class="discount-info">
      ...
      <span>{{ t('cart.discountApplied', { amount: formattedDiscount }) }}</span>
    </div>
  </div>
</template>
