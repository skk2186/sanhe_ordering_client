  ...
  <div class="login-container">
    ...
    <div class="login-card">
      ...
      <div class="login-header">
        ...
        <h1 class="title">{{ $t('auth.employeeSystem') }}</h1>
        <p class="subtitle">{{ $t('auth.employeeLogin') }}</p>
      </div>
      ...
      <div class="login-footer">
        <el-divider>
          <span class="divider-text">{{ $t('auth.otherLogin') }}</span>
        </el-divider>
    ...
    <div class="version-info">
      <span>{{ $t('common.version') }} {{ appConfig.version }}</span>
