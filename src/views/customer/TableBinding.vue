<template>
  <div class="table-binding">
    ...
    <div class="brand-header">
      <div class="line-logo">
        <img src="/images/line-friends-logo.svg" alt="LINE FRIENDS联名" class="logo-img">
    ...
    <div class="binding-content">
      ...
      <div class="table-input-section">
        <div class="input-container">
          <h2 class="input-title">请输入桌号</h2>
          <p class="input-subtitle">扫码后请输入您的桌号开始点餐</p>
...
const bindTable = async () => {
  ...
  if (!tablePattern.test(tableNum)) {
    showError('桌号格式不正确，请输入如 A08 的格式')
    return
  }
...
const handleBindingSuccess = async (tableNum) => {
  ...
  bubbleText.value = `欢迎来到 ${tableNum} 桌！`
...
onMounted(() => {
  ...
  setTimeout(() => {
    showBubble.value = true
    bubbleText.value = '请输入您的桌号开始美食之旅！'
  }, 1000)
})
</script>
